...
| `just publish` | No-op; this project does not publish Maven artifacts |
...
This project consumes [swissknife](https://github.com/sollecitom/swissknife), [pillar](https://github.com/sollecitom/pillar), and [acme-schema-catalogue](https://github.com/sollecitom/acme-schema-catalogue) via published versions from `mavenLocal()`.
